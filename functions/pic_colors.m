...
switch colorOption
  ...
  case 'waterfall2' % fancy-schmancy
    c = [55,137,187;...
        ...
        10 100 150]/255;
    colors = interp1(linspace(1,64,size(c,1)),c,1:64);    
  case 'waterfall_gray' % fancy-schmancy
      c = [240.0000  240.0000  240.0000;...
        106,193,165;...
        172,220,166;...
        230,244,157;...
        255,254,194;...
        ...
        211,064,082]/255;
      colors = interp1(linspace(1,64,size(c,1)),c,1:64);
  case 'candy_gray' % fancy-schmancy
      c = [240.0000  240.0000  240.0000;...
        106,193,165;...
        172,220,166;...
        230,244,157;...
        ...
        100,054,082]/255;
      colors = interp1(linspace(1,64,size(c,1)),c,1:64);
  case 'waterfall_white' % fancy-schmancy
      c = [250.0000  250.0000  250.0000;...
        106,193,165;...
        172,220,166;...
        230,244,157;...
        255,254,194;...
