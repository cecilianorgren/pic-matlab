function h5write_dists(data_dir,filePath,distIndices,nSpecies)
% H5WRITE_DISTS Write Michael's simulation output distribution data to h5 file.
% H5WRITE_DISTS(dirData,h5filePath,distIndices,nSpecies)
%
...
%   all in directory and check them against existing (if any) ones
