...
if 1 % dUT
  ...
  plot(hca,twci1,UTi1-UTi1(1),twci2,UTi2-UTi2(1),twci1,UKi1-UKi1(1),twci2,UKi2-UKi2(1))
  hca.XLabel.String = 't\omega_{ci}';
  hca.YLabel.String = 'Change in energy';
  legend(hca,{'UTi1','UTi1','Uki1','Uki1'})
end
...
%% var(x,z=0,t)
clims = {[-0.03 0.03],[-0.03 0.03],[-0.03 0.03],[-0.15 0.15],[-0.45 0.45],[-0.15 0.15],[0 0.8]};
varstrs = {'Ey','Bz','vix','vex','viy','By','Jy'}';
...
zlim = 0.5 + 0.25*[-1 1];
h1 = pic1.twcilim([0 Inf]).zlim(zlim).plot_timemap(h(:,1),'xt',varstrs,'clim',clims,'smooth',1,'grid');
h2 = pic2.twcilim([0 Inf]).zlim(zlim).plot_timemap(h(:,2),'xt',varstrs,'clim',clims,'smooth',1,'grid');
h3 = pic3.twcilim([0 Inf]).zlim(zlim).plot_timemap(h(:,3),'xt',varstrs,'clim',clims,'smooth',1,'grid');
