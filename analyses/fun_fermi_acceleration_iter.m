function out = fun_fermi_acceleration_iter(m,vt,vd,vdf,niter,doPlot)
% out = fun_fermi_acceleration_iter(m,vt,vd,vdf,niter,doPlot);
% Estimate the fermi acceleration temperature gain dependence on initial temperature
% v_after = -v_before + 2*v_DF.
% Does the reflection niter times.
%
% NOT IMPLEMENTED
%
% See also FUN_FERMI_ACCELERATION
