...
if 1 % RE2
  ...
  hRE = plot(hca,df04n.RE,df04n.twci);
  ...
  hl = line(df04n_nxline_z1,df04n.twci,'Parent',ax2,'Color','k');
  legend([hRE hl],{'E_R','n(x_x,z_x+1)'},'location','bestoutside')
end
if 0 % Ey1
  hca = h(isub); isub = isub + 1;
  varplot = squeeze(mean(pic2.Ey,2));
  pcolor(hca,pic2.xi,pic2.twci,varplot')
  shading(hca,'flat')
  ...
  if doA
    ...
    contour(hca,pic2.xi(1:istepA:end),pic2.twci,plA(1:istepA:end,:)',Alev,'color',[0 0 0])
    hold(hca,'off')
  end
end
if 1 % Bz1
  hca = h(isub); isub = isub + 1;
  varplot = squeeze(mean(pic2.Bz,2));
  pcolor(hca,pic2.xi,pic2.twci,varplot')
  shading(hca,'flat')
  colormap(hca,pic_colors('blue_red'))
  hca.XGrid = 'on';
...
if 1 % nhot
  hca = h(isub); isub = isub + 1;
  varplot = squeeze(mean(pic2.n(1),2));
  pcolor(hca,pic2.xi,pic2.twci,varplot')
  shading(hca,'flat')
  colormap(hca,pic_colors('blue_red'))
  hca.XGrid = 'on';
...
if 1 % ncold
  hca = h(isub); isub = isub + 1;
  varplot = squeeze(mean(pic2.n(3),2));
  pcolor(hca,pic2.xi,pic2.twci,varplot')
  shading(hca,'flat')
  colormap(hca,pic_colors('blue_red'))
  hca.XGrid = 'on';
...
if 0 % Ey2
  hca = h(isub); isub = isub + 1;
  varplot = squeeze(mean(pic1.Ey,2));
  pcolor(hca,pic1.xi,pic2.twci,varplot')
  shading(hca,'flat')
  colormap(hca,pic_colors('blue_red'))
  hca.XGrid = 'on';
  hca.YGrid = 'on';
...
if 0 % Bz2
  hca = h(isub); isub = isub + 1;
  varplot = squeeze(mean(pic1.Bz,2));
  pcolor(hca,pic1.xi,pic2.twci,varplot')
  shading(hca,'flat')
  colormap(hca,pic_colors('blue_red'))
  hca.XGrid = 'on';
